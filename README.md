...
参考：https://github.com/e421083458/golang_common 感谢大佬
...
## 定位
配置 Golang 基础服务（mysql、postgresql、redis、http.client、log）比较繁琐，如果想 **快速接入** 基础服务可以使用本类库。
没有多余复杂的功能，方便你拓展其他功能。
...
## 功能
 ...
 2. mysql、postgresql、redis 多套数据源配置。
